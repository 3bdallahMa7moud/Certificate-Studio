...
const EDITORIAL_ELEMENTS = [
  ...
  textElement({
    ...
    labelEn: 'Achievement',
    labelAr: 'الإنجاز',
    contentKeys: ['achievementAr', 'achievementEn'],
    x: 228,
    y: 93,
    width: 55,
    height: 22,
...
const RAINBOW_STARS_ELEMENTS = createChildTemplateElements('rainbow-stars', {
  ...
  grade: { x: 28, y: 143, width: 48, height: 12 },
  subject: { x: 82, y: 143, width: 56, height: 12 },
  achievement: { x: 144, y: 143, width: 72, height: 12 },
  date: { x: 222, y: 143, width: 48, height: 12 },
...
const JUNGLE_FRIENDS_ELEMENTS = createChildTemplateElements('jungle-friends', {
  ...
  grade: { x: 28, y: 146, width: 48, height: 12 },
  subject: { x: 82, y: 146, width: 56, height: 12 },
  achievement: { x: 144, y: 146, width: 72, height: 12 },
  date: { x: 222, y: 146, width: 48, height: 12 },
...
const SPACE_EXPLORER_ELEMENTS = createChildTemplateElements('space-explorer', {
  ...
  grade: { x: 28, y: 147, width: 48, height: 12 },
  subject: { x: 82, y: 147, width: 56, height: 12 },
  achievement: { x: 144, y: 147, width: 72, height: 12 },
  date: { x: 222, y: 147, width: 48, height: 12 },
...
const STORYBOOK_CASTLE_ELEMENTS = createChildTemplateElements('storybook-castle', {
  ...
  grade: { x: 28, y: 145, width: 48, height: 12 },
  subject: { x: 82, y: 145, width: 56, height: 12 },
  achievement: { x: 144, y: 145, width: 72, height: 12 },
  date: { x: 222, y: 145, width: 48, height: 12 },
...
const ISLAMIC_HERITAGE_ELEMENTS = createChildTemplateElements('islamic-heritage', {
  ...
  grade: { x: 28, y: 155, width: 48, height: 12 },
  subject: { x: 82, y: 155, width: 56, height: 12 },
  achievement: { x: 144, y: 155, width: 72, height: 12 },
  date: { x: 222, y: 155, width: 48, height: 12 },
